    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php //if(in_array('createGroup', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Добавить свойство</button>
          <br /> <br />
        <?php //endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Редактировать свойства</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('attributes/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="attribute_name" name="attribute_name" placeholder="Введите название свойства" autocomplete="off">
          </div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Редактировать свойство</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="edit_attribute_name" name="edit_attribute_name" placeholder="Введите название свойства" autocomplete="off">
          </div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Удалить свойство</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/remove') ?>" method="post" id="removeForm">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Открыть</button>
